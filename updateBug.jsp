...
<nav class="top-nav">
    ...
    <div class="nav-links">
        ...
        <a class="active" href="addBug.jsp">Add Bug</a>
...
<%
    ...
    if ("POST".equals(request.getMethod())) {
        ...
        out.println("<h3>Bug Updated Successfully!</h3>");
    }
%>
...
<div class="form-wrapper">
    <div class="form-card">
        ...
        <form method="post">
            ...
            <label>Bug ID</label>
            <input type="number" name="id" placeholder="Enter Bug ID" required>

            <label>New Title</label>
            <input type="text" name="title" placeholder="Enter new title" required>

            <label>New Description</label>
            <input type="text" name="desc" placeholder="Enter new description" required>
